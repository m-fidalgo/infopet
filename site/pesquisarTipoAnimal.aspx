<%@ Page Title="" Language="C#" MasterPageFile="~/modelo.master" AutoEventWireup="true" CodeFile="~/cs/pesquisarTipoAnimal.aspx.cs" Inherits="pesquisarTipoAnimal" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div class="progCont">
        ...
        <br />
        <br />
        <h1 class="tituloProg">Pesquisar Tipo de Animal</h1>
        <br />
        ...
        <br />
        <br />
        <asp:SqlDataSource ID="sqlPesqTipoAnimal" runat="server" ConnectionString="<%$ ConnectionStrings:infoPetConnectionString %>" ProviderName="<%$ ConnectionStrings:infoPetConnectionString.ProviderName %>" SelectCommand="SELECT id_tipoAnimal, nome_tipoAnimal FROM tipoanimal WHERE (nome_tipoAnimal = @PESQ)">
            <SelectParameters>
