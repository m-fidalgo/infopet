<%@ Page Title="" Language="C#" MasterPageFile="~/modelo.master" AutoEventWireup="true" CodeFile="~/cs/excluirProd.aspx.cs" Inherits="excluirProd" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div class="progCont">
        ...
        <br />
        <br />
        <asp:Image ID="img" runat="server" CssClass="progImg" ReadOnly="True"/>
        <br />
        <br />
        <br />
        ...
        <br />
        <br />
        <asp:SqlDataSource ID="sqlExcProd" runat="server" ConnectionString="<%$ ConnectionStrings:infoPetConnectionString %>" ProviderName="<%$ ConnectionStrings:infoPetConnectionString.ProviderName %>" SelectCommand="SELECT id_prod, nome_prod, descr_prod, preco_prod, imagem_prod, id_tipoProd FROM produto WHERE (nome_prod = @PESQ)" DeleteCommand="DELETE FROM produto WHERE (nome_prod = @PESQ)">
            <DeleteParameters>
