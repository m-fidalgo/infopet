<%@ Page Title="" Language="C#" MasterPageFile="~/modelo.master" AutoEventWireup="true" CodeFile="~/cs/pesquisarTipoProd.aspx.cs" Inherits="pesquisarTipoProd" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div class="progCont">
        ...
        <br />
        <br />
        <h1 class="tituloProg">Pesquisar Tipo de Produto</h1>
        <br />
        ...
        <br />
        <br />
        <asp:SqlDataSource ID="sqlPesqTipoProd" runat="server" ConnectionString="<%$ ConnectionStrings:infoPetConnectionString %>" ProviderName="<%$ ConnectionStrings:infoPetConnectionString.ProviderName %>" SelectCommand="SELECT id_tipoProd, nome_tipoProd FROM tipoprod WHERE (nome_tipoProd = @PESQ)">
            <SelectParameters>
