<%@ Page Title="" Language="C#" MasterPageFile="~/modelo.master" AutoEventWireup="true" CodeFile="~/cs/excluirTipoProd.aspx.cs" Inherits="excluirTipoProd" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div class="progCont">
        ...
        <br />
        <br />
        <h1 class="tituloProg">Excluir Tipo de Produto</h1>
        <br />
        ...
        <br />
        <br />
        <asp:SqlDataSource ID="sqlExcTipoProd" runat="server" ConnectionString="<%$ ConnectionStrings:infoPetConnectionString %>" DeleteCommand="DELETE FROM tipoprod WHERE (nome_tipoProd = @PESQ)" ProviderName="<%$ ConnectionStrings:infoPetConnectionString.ProviderName %>" SelectCommand="SELECT id_tipoProd, nome_tipoProd FROM tipoprod WHERE (nome_tipoProd = @PESQ)">
            <DeleteParameters>
