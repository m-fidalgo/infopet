<%@ Page Title="" Language="C#" MasterPageFile="~/modelo.master" AutoEventWireup="true" CodeFile="~/cs/produtosPassaros.aspx.cs" Inherits="produtosPassaros" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <h1 class="tituloProgExibir">Produtos - Pássaros</h1>
    <br />
    <br />
    <div class="btnProd">
    ...
    <br />
    <br />
    <asp:DataList ID="DataList1" runat="server" DataSourceID="sqlProdPassaros" CssClass="dlCss" RepeatColumns="2" RepeatDirection="Horizontal" >
